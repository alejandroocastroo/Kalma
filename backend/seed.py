...
async def seed():
    async with AsyncSessionLocal() as db:
        ...
        tenant = Tenant(
            ...
            slug="mantra",
            phone="+573001234567",
            email="hola@mantrapilates.co",
            address="Calle 93 #14-20, Chicó Norte",
            city="Bogotá",
            description="Estudio boutique de Pilates en el corazón de Bogotá. Transformamos cuerpos y mentes a través de la práctica consciente del Pilates Reformer, Mat y Terapéutico.",
            logo_url=None,
            cover_url="https://images.unsplash.com/photo-1518611012118-696072aa579a?w=1200",
            instagram_url="https://instagram.com/mantrapilates.co",
